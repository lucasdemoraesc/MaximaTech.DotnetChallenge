...
WORKDIR /src
COPY ["MaximaTech.DotnetChallenge.Api/MaximaTech.DotnetChallenge.Api.csproj", "MaximaTech.DotnetChallenge.Api/"]
RUN dotnet restore "MaximaTech.DotnetChallenge.Api/MaximaTech.DotnetChallenge.Api.csproj"
COPY . .
